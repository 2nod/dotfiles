...
実装もPRやissueの会話も知らないレビュワーが5分程度で、対象の役割、変更、根拠、判断事項を追えるHTMLを作る。
...
2. `templates/report-outline.md` を使う。00の冒頭で、対象の役割、利用者または運用者、発火条件、代表的な入力と出力を説明してから、変更目的、Before / After、未変更範囲、判断事項を示す。
...
9. 詳細は必要なものだけを折りたたみ、図は文章とコードだけでは経路を追えない場合に置く。
